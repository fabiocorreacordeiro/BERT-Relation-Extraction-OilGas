...
BERT_PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    'bert-base-multilingual-cased': "/home/U4VN/transformers_cache/bert-base-multilingual-cased-pytorch_model.bin",
    ...
    #'neuralmind/bert-base-portuguese-cased': "https://mirrors.tuna.tsinghua.edu.cn/hugging-face-models/neuralmind/bert-base-portuguese-cased/pytorch_model.bin",
#    'neuralmind/bert-base-portuguese-cased': "/home/UPE2/transformers_cache/bert-base-portuguese-cased-pytorch-model.bin",
    'neuralmind/bert-base-portuguese-cased': '/projetos/UPE2/.cache/torch/transformers/bert-base-portuguese-cased-pytorch-model.bin',
    #'neuralmind/bert-large-portuguese-cased': "https://mirrors.tuna.tsinghua.edu.cn/hugging-face-models/neuralmind/bert-large-portuguese-cased/pytorch_model.bin"
    'neuralmind/bert-large-portuguese-cased': '/projetos/UPE2/.cache/torch/transformers/bert-large-portuguese-cased-pytorch-model.bin'
...
class BertModel(BertPreTrainedModel):
    ...
    def __init__(self, config, model_size, task=None, n_classes_=None):
        ...
        if self.task is None:
            ...
            elif self.model_size == 'neuralmind/bert-base-portuguese-cased':
                self.classification_layer = nn.Linear(1536, n_classes_)
            elif self.model_size == 'neuralmind/bert-large-portuguese-cased':
                self.classification_layer = nn.Linear(2048, n_classes_)
